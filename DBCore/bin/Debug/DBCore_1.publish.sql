...
GO
:setvar DatabaseName "DBCore"
:setvar DefaultFilePrefix "DBCore"
...
END
GO
PRINT N'Creating [dbo].[spEditEmployee]...';
...
END
GO
PRINT N'Creating [dbo].[spGetEmployee]...';
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '041e1f4c-2592-4a95-9d7e-ed0a6316d2a5')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('041e1f4c-2592-4a95-9d7e-ed0a6316d2a5')
